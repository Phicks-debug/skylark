// Skylark - C++ CLI for running Gemma models with LiteRT-LM
...
static void print_help(const char* prog) {
    std::cout << R"(Skylark - Interactive CLI for Gemma models via LiteRT-LM
...
static void chat_loop(const Config& cfg) {
    ...
    cprintln("Skylark - Type your message (Ctrl+C to cancel, Ctrl+D to exit)",
            Color::BrightWhite);
    ...
    // ---- Chat loop ----
    std::string line;
    std::string audio_file = "/tmp/skylark_recording.wav";
